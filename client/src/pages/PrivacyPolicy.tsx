...
export default function PrivacyPolicy() {
  return (
    <LegalPageLayout title="Privacy Policy" updated="26 June 2026">
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">1. Who we are</h2>
        <p>
      ...
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">2. Information we collect</h2>
      ...
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">3. How we use your information</h2>
      ...
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">4. Sharing your data</h2>
        <p>
      ...
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">5. Data retention</h2>
        <p>
      ...
      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">6. Your rights</h2>
        <p>
          You may request access to, correction of, or deletion of your personal data by contacting us at{' '}
          <a href={`mailto:${BRAND.contact.emails[0]}`} className="text-[#F05030] hover:underline">{BRAND.contact.emails[0]}</a>.
        </p>
      </section>

      <section>
        <h2 className="font-[family-name:var(--font-display)] font-700 text-xl text-[#111111] mb-3">7. Contact</h2>
        <p>
