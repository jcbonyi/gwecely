      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h2 className="font-[family-name:var(--font-display)] font-800 text-4xl md:text-5xl text-[#111111] section-heading mb-5">
              RELIABLE HOSPITALITY
              <br />
              <span className="text-[#F05030]">PROCUREMENT SOLUTIONS</span>
            </h2>
            <p className="text-gray-600 font-[family-name:var(--font-body)] text-sm leading-relaxed mb-6">
            ...
            <ul className="grid sm:grid-cols-2 gap-3 mb-8">
              {HOSPITALITY_PROCUREMENT_SERVICES.map((service) => (
                <li key={service} className="flex items-center gap-2 text-sm text-gray-700 font-[family-name:var(--font-body)]">
                  <CheckCircle size={16} className="text-[#F05030] flex-shrink-0" />
                  {service}
                </li>
              ))}
            </ul>
